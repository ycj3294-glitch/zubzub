...
public interface AuctionRepository extends JpaRepository<Auction, Long> {
    ...
    Page<Auction> findByAuctionType(String type, Pageable pageable);
    // AuctionType과 날짜로 조회
    List<Auction> findByAuctionTypeAndStartTimeBetween(String type, LocalDateTime start, LocalDateTime end);
}
